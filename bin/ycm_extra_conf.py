...
# directory.
    ...
    if os.path.islink(original_file):
        ...
        tools_directory = os.path.dirname(link_file)
    else:
        tools_directory = os.path.dirname(original_file)

    webkitbuild_path = os.path.abspath(os.path.join(tools_directory, '../out/'))
